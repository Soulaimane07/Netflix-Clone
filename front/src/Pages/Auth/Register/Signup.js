...
function Signup() {
  ...
  return (
    <>
        <div className='Header text-mywhite min-h-screen bg-primary p-10 items-center' style={{ backgroundImage: `url(../assets/images/stars_bg.webp)`}}>
            ...
            <div className='w-3/12  mx-auto mt-10'>
                ...
                <form onSubmit={SignupFun} className='mb-10'>
                    ...
                    <div className='h-12 flex items-center justify-center'><Error display={error} text="Your information are wrong !" /></div>
